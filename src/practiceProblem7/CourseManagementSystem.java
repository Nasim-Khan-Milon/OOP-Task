...
public class CourseManagementSystem {
    public static void main(String[] args) {
        ...
        Instructor instructor = new Instructor(101, "Dr. Smith", "CS Department", "Professor");
        instructor.displayInstructor();

        Course course = new Course(301, "Java Programming Syllabus", "Java Programming", "3", "Basic Programming");
        course.displayCourse();

        CourseOffering offering = new CourseOffering(1, 101, 301, new Date(), 1, 202, 2025, 'F');
